...
conv_1 = keras.layers.convolutional.Convolution2D(
    32, 8, 8, subsample=(4, 4), activation='relu')(keras.layers.Lambda(lambda x: x / 255.0)(frames_input))
conv_2 = keras.layers.convolutional.Convolution2D(
    64, 4, 4, subsample=(2, 2), activation='relu')(conv_1)
conv_3 = keras.layers.convolutional.Convolution2D(
    64, 3, 3, subsample=(1, 1), activation='relu')(conv_2)
